...
//        response.sendRedirect();
    ...
    public ResponseEntity<String> joinWithSocialLogin(
        ...
        List<String> cookies = userService.joinSocial(request, response);
        ...
        response.sendRedirect(redirectUrlDto.getRedirectUrl());
        return ResponseEntity.ok("회원가입 성공");
    }
    ...
    public ResponseEntity<String> unlinkSocial(
        ...
        userService.unlinkSocial(request, response);
        response.sendRedirect(redirectUrlDto.getRedirectUrl());
        return ResponseEntity.ok("회원가입 취소 완료");
    }
