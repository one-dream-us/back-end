...
//		List<DictionaryHistory> userScraps = dictionaryHistoryRepository.findByUserAndIsDeletedFalse(user);
//		// 사용자 스크랩 정보를 Map으로 변환 (DictionaryId -> DictionaryScrap)
//		Map<Long, DictionaryHistory> userScrapMap = userScraps.stream()
...
//						// Map에서 스크랩 정보 조회
//						DictionaryHistory dictionaryHistory = userScrapMap.get(dictionaryId);
//
//						result.add(DictionaryScrapInfo.builder()
//							.dictionaryId(dictionaryId)
//							.dictionaryScrapId(
//								dictionaryHistory != null ? dictionaryHistory.getId() : null)
//							.isScrapped(dictionaryHistory != null)
//							.build());
//					}
//				});
//
