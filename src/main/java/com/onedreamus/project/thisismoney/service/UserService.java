...
public class UserService {
     ...
     * 소셜로그인 회원가입
     */
    public List<String> joinSocial(HttpServletRequest request, HttpServletResponse response) {
     ...
     * 소셜 연동 해제
     */
    public void unlinkSocial(HttpServletRequest request, HttpServletResponse response) {
        // 쿠키 조회
        String verifyToken = findTokenFromCookie(request.getCookies(), TokenType.VERIFY_TOKEN);
        ...
        Long socialId = jwtUtil.getSocialId(verifyToken);
